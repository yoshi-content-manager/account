              ...
              <div className='flex flex-col items-center justify-center mb-6'>
                ...
                <div className='flex items-center justify-center'>
                  <label htmlFor='avatar' className='cursor-pointer'>
                    <div className='px-4 py-2 bg-orange-100 text-orange-700 rounded-md text-sm font-medium hover:bg-orange-200 transition-colors'>
                      Change Avatar
                    </div>
                    <input
                      id='avatar'
